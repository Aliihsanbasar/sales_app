...
public class Admin extends javax.swing.JFrame {
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        String prstock = txtprstock.getText().trim();
        String prnote = txtprnote.getText().trim();
        int curtype = curTypeCom.getSelectedIndex();
        
        int statu = prmd.productUpdate(prid, getCid, prtitle, Double.parseDouble(prprice), prbarcode, prshelf, Integer.parseInt(prstock), prnote, curtype);
        if (statu > 0) {
            prid = -1;
            productResultRefresh();
            txtprtitle.setText("");
    ...
    private void tblProductMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblProductMousePressed
        ...
        String d = String.valueOf(tblProduct.getValueAt(row, 4));
        String b = String.valueOf(tblProduct.getValueAt(row, 5));
        String r = String.valueOf(tblProduct.getValueAt(row, 6));
        String s = String.valueOf(tblProduct.getValueAt(row, 7));
        String n = String.valueOf(tblProduct.getValueAt(row, 8));
        ...
        txtprnote.setText(n);
        curTypeCom.setSelectedIndex(Integer.parseInt(d));
